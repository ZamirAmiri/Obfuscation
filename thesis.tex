...
\textbf{Step 1}\hypertarget{attack1}.\newline After gaining the ability to execute code from a remote location, the attacker will gain access through executing a [\hyperlink{16}{16}]reverse shell script on the victim machine. In this case the reverse shell script of section 3.4.4 was used. The executed code on the victims machine in this case is:
\begin{verbatim}
...
\hypertarget{13}\item Evolution of Computer Virus Concealment and Anti-Virus Techniques: A Short Survey | Babak Bashari Rad
\hypertarget{14}\item A Study on Security Information and Event Management (SIEM)
\hypertarget{15}\item A Comparison Between Signature and Machine
Learning Based Detectors | Adetokunbo Makanju, Patrick LaRoche, A. Nur Zincir-Heywood
\hypertarget{16}\item Reverse TCP and Social Engineering Attacks in the Era of Big Data | Thaier Hayajneh
\end{enumerate}
\subsection{Other}
\begin{enumerate}
